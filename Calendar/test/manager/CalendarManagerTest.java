...
class CalendarManagerTest {
	...
	void testCalendarManager() {
		...
		c.deleteCalendar();
		c.createEvent("Job", "12:20p", "1:20p", 3, 5, 1800);
		c.createEvent("Job", "12:20p", "1:20p", 2, 5, 1800);
		c.createEvent("Job", "12:20p", "1:20p", 1, 5, 1800);
		c.createEvent("Job", "12:20p", "1:20p", 3, 6, 1800);
		...
		c.editEvent(c.getEvents().getAtIndex(3).getDate(), c.getEvents().getAtIndex(3).getStartInt(), "Job", "12:20p", "1:25p", 4, 6, 1800);
		assertEquals(4, c.getEvents().getAtIndex(3).getDay());
		
		c.createEvent("Job", "12:20p", "1:20p", 5, 5, 1800);
		c.createEvent("Job", "12:20p", "1:20p", 6, 5, 1800);
		assertEquals(1, c.getEvents().getAtIndex(0).getDay());
		assertEquals(2, c.getEvents().getAtIndex(1).getDay());
		assertEquals(3, c.getEvents().getAtIndex(2).getDay());
