...
class SortedDateListTest {
	...
	void testRemoveE() {
		...
		EventData e5 = new EventData("Job", "1215a", "415p", 8, 12, 2024, 100, 100, 100, SyncState.Synced, " ", " ");
		EventData e6 = new EventData("Job", "1215a", "415p", 15, 12, 2024, 100, 100, 100, SyncState.Synced, " ", " ");
		EventData e7 = new EventData("Job", "1215a", "415p", 19, 12, 2024, 100, 100, 100, SyncState.Synced, " ", " ");
