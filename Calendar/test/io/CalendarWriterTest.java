...
class CalendarWriterTest {
	...
	void testWriteCalendar() {
		...
		CalendarWriter.writeCalendar(new File("testFiles/calendartest1.txt"), s);
		SortedDateList<EventData> s2 = CalendarReader.readCalendar(new File("testFiles/calendartest1.txt"));
		...
		CalendarWriter.writeCalendar(new File("testFiles/calendartest1.txt"), s2);
		s2 = CalendarReader.readCalendar(new File("testFiles/calendartest1.txt"));
		assertEquals(e1.getDate(), s2.getAtIndex(0).getDate());
		assertEquals(e2.getDate(), s2.getAtIndex(1).getDate());
		assertEquals(e3.getDate(), s2.getAtIndex(2).getDate());
		assertEquals(e4.getDate(), s2.getAtIndex(3).getDate());
